...
class BluetoothLEAdvertisement(_winrt.Object):
    ...
    data_sections: typing.Optional[bleak_winrt.windows.foundation.collections.IVector[BluetoothLEAdvertisementDataSection]]
    manufacturer_data: typing.Optional[bleak_winrt.windows.foundation.collections.IVector[BluetoothLEManufacturerData]]
    service_uuids: typing.Optional[bleak_winrt.windows.foundation.collections.IVector[_winrt.Guid]]
    @staticmethod
    ...
    def get_manufacturer_data_by_company_id(self, company_id: _winrt.UInt16) -> typing.Optional[bleak_winrt.windows.foundation.collections.IVectorView[BluetoothLEManufacturerData]]: ...
    def get_sections_by_type(self, type: _winrt.UInt8) -> typing.Optional[bleak_winrt.windows.foundation.collections.IVectorView[BluetoothLEAdvertisementDataSection]]: ...

class BluetoothLEAdvertisementBytePattern(_winrt.Object):
    offset: _winrt.Int16
    data_type: _winrt.UInt8
    data: typing.Optional[bleak_winrt.windows.storage.streams.IBuffer]
    @staticmethod
    ...
    @typing.overload
    def __new__(cls: typing.Type[BluetoothLEAdvertisementBytePattern], data_type: _winrt.UInt8, offset: _winrt.Int16, data: typing.Optional[bleak_winrt.windows.storage.streams.IBuffer]) -> BluetoothLEAdvertisementBytePattern:...
...
class BluetoothLEAdvertisementDataSection(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[BluetoothLEAdvertisementDataSection], data_type: _winrt.UInt8, data: typing.Optional[bleak_winrt.windows.storage.streams.IBuffer]) -> BluetoothLEAdvertisementDataSection:...
...
class BluetoothLEAdvertisementFilter(_winrt.Object):
    ...
    byte_patterns: typing.Optional[bleak_winrt.windows.foundation.collections.IVector[BluetoothLEAdvertisementBytePattern]]
    @staticmethod
...
class BluetoothLEAdvertisementPublisher(_winrt.Object):
    ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
    def add_status_changed(self, handler: bleak_winrt.windows.foundation.TypedEventHandler[BluetoothLEAdvertisementPublisher, BluetoothLEAdvertisementPublisherStatusChangedEventArgs]) -> bleak_winrt.windows.foundation.EventRegistrationToken: ...
    def remove_status_changed(self, token: bleak_winrt.windows.foundation.EventRegistrationToken) -> None: ...
...
class BluetoothLEAdvertisementReceivedEventArgs(_winrt.Object):
    ...
    bluetooth_address_type: bleak_winrt.windows.devices.bluetooth.BluetoothAddressType
    is_anonymous: _winrt.Boolean
...
class BluetoothLEAdvertisementWatcher(_winrt.Object):
    ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
    def add_received(self, handler: bleak_winrt.windows.foundation.TypedEventHandler[BluetoothLEAdvertisementWatcher, BluetoothLEAdvertisementReceivedEventArgs]) -> bleak_winrt.windows.foundation.EventRegistrationToken: ...
    def remove_received(self, token: bleak_winrt.windows.foundation.EventRegistrationToken) -> None: ...
    def add_stopped(self, handler: bleak_winrt.windows.foundation.TypedEventHandler[BluetoothLEAdvertisementWatcher, BluetoothLEAdvertisementWatcherStoppedEventArgs]) -> bleak_winrt.windows.foundation.EventRegistrationToken: ...
...
class BluetoothLEManufacturerData(_winrt.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[BluetoothLEManufacturerData], company_id: _winrt.UInt16, data: typing.Optional[bleak_winrt.windows.storage.streams.IBuffer]) -> BluetoothLEManufacturerData:...
