...
class Deferral(IClosable, typing.ContextManager[Deferral], _winrt.winrt_base):
    ...
    def complete() -> None:
        ...
    def close() -> None:
...
class MemoryBuffer(IMemoryBuffer, IClosable, typing.ContextManager[MemoryBuffer], _winrt.winrt_base):
    ...
...
class WwwFormUrlDecoder(bleak_winrt.windows.foundation.collections.IVectorView[IWwwFormUrlDecoderEntry], bleak_winrt.windows.foundation.collections.IIterable[IWwwFormUrlDecoderEntry], _winrt.winrt_base):
    ...
    size: int
    def get_first_value_by_name(name: str) -> str:
        ...
    def first() -> bleak_winrt.windows.foundation.collections.IIterator[IWwwFormUrlDecoderEntry]:
        ...
...
class IAsyncAction(IAsyncInfo, typing.Awaitable[None], _winrt.winrt_base):
    ...
...
class IAsyncActionWithProgress(IAsyncInfo, typing.Awaitable[None], _winrt.winrt_base):
    ...
...
class IAsyncOperationWithProgress(IAsyncInfo, typing.Awaitable[TResult], _winrt.winrt_base):
    ...
...
class IAsyncOperation(IAsyncInfo, typing.Awaitable[TResult], _winrt.winrt_base):
    ...
...
class IClosable(typing.ContextManager[IClosable], _winrt.winrt_base):
    ...
    def close() -> None:
        ...
...
class IMemoryBuffer(IClosable, typing.ContextManager[IMemoryBuffer], _winrt.winrt_base):
    ...
    def create_reference() -> IMemoryBufferReference:
        ...
    def close() -> None:
...
class IMemoryBufferReference(IClosable, typing.ContextManager[IMemoryBufferReference], _winrt.winrt_base):
    ...
    capacity: int
    def close() -> None:
        ...
