...
namespace py::cpp::Windows::Foundation::Collections
{
    ...
    static PyObject* register_CollectionChange(PyObject* module, PyObject* type)
    {
    ...
    // ----- PropertySet class --------------------
    constexpr const char* const type_name_PropertySet = "PropertySet";
    ...
    {
        "_bleak_winrt_Windows_Foundation_Collections.PropertySet",
    ...
    // ----- StringMap class --------------------
    constexpr const char* const type_name_StringMap = "StringMap";
    ...
    {
        "_bleak_winrt_Windows_Foundation_Collections.StringMap",
    ...
    // ----- ValueSet class --------------------
    constexpr const char* const type_name_ValueSet = "ValueSet";
    ...
    {
        "_bleak_winrt_Windows_Foundation_Collections.ValueSet",
    ...
    // ----- IIterable interface --------------------
    constexpr const char* const type_name_IIterable = "IIterable";
    ...
    {
        "_bleak_winrt_Windows_Foundation_Collections.IIterable",
    ...
    // ----- IIterator interface --------------------
    constexpr const char* const type_name_IIterator = "IIterator";
    ...
    {
        "_bleak_winrt_Windows_Foundation_Collections.IIterator",
    ...
    constexpr const char* const type_name_IKeyValuePair = "IKeyValuePair";
    ...
    {
        "_bleak_winrt_Windows_Foundation_Collections.IKeyValuePair",
    ...
    constexpr const char* const type_name_IMapChangedEventArgs = "IMapChangedEventArgs";
    ...
    {
        "_bleak_winrt_Windows_Foundation_Collections.IMapChangedEventArgs",
    ...
    // ----- IMapView interface --------------------
    constexpr const char* const type_name_IMapView = "IMapView";
    ...
    {
        "_bleak_winrt_Windows_Foundation_Collections.IMapView",
    ...
    // ----- IMap interface --------------------
    constexpr const char* const type_name_IMap = "IMap";
    ...
    {
        "_bleak_winrt_Windows_Foundation_Collections.IMap",
    ...
    constexpr const char* const type_name_IObservableMap = "IObservableMap";
    ...
    {
        "_bleak_winrt_Windows_Foundation_Collections.IObservableMap",
    ...
    constexpr const char* const type_name_IObservableVector = "IObservableVector";
    ...
    static PyObject* IObservableVector_get_insert(PyObject* self) noexcept
    {
    ...
    static PyGetSetDef _getset_IObservableVector[] = {
        ...
        { "insert", reinterpret_cast<getter>(IObservableVector_get_insert), nullptr, nullptr, nullptr },
        { }
    };
    ...
    {
        "_bleak_winrt_Windows_Foundation_Collections.IObservableVector",
    ...
    constexpr const char* const type_name_IPropertySet = "IPropertySet";
    ...
    {
        "_bleak_winrt_Windows_Foundation_Collections.IPropertySet",
    ...
    constexpr const char* const type_name_IVectorChangedEventArgs = "IVectorChangedEventArgs";
    ...
    {
        "_bleak_winrt_Windows_Foundation_Collections.IVectorChangedEventArgs",
    ...
    constexpr const char* const type_name_IVectorView = "IVectorView";
    ...
    static PyObject* IVectorView_get_insert(PyObject* self) noexcept
    {
        return PyObject_GetAttrString(self, "insert_at");
    }
    ...
    {
        "_bleak_winrt_Windows_Foundation_Collections.IVectorView",
    ...
    // ----- IVector interface --------------------
    constexpr const char* const type_name_IVector = "IVector";
    ...
    static PyObject* IVector_get_insert(PyObject* self) noexcept
    {
        return PyObject_GetAttrString(self, "insert_at");
    }
    ...
    static PyGetSetDef _getset_IVector[] = {
        ...
        { "insert", reinterpret_cast<getter>(IVector_get_insert), nullptr, nullptr, nullptr },
        { }
    };
    ...
    {
        "_bleak_winrt_Windows_Foundation_Collections.IVector",
    ...
    static PyModuleDef module_def
        = {PyModuleDef_HEAD_INIT,
           "_bleak_winrt_Windows_Foundation_Collections",
           module_doc,
           sizeof(module_state),
           module_methods,
           nullptr,
...
PyMODINIT_FUNC PyInit__bleak_winrt_Windows_Foundation_Collections(void) noexcept
{
    ...
    state->type_PropertySet = py::register_python_type(module.get(), type_name_PropertySet, &type_spec_PropertySet, mutable_mapping_bases.get());
    if (!state->type_PropertySet)
    {
        return nullptr;
    }

    Py_INCREF(state->type_PropertySet);

    state->type_StringMap = py::register_python_type(module.get(), type_name_StringMap, &type_spec_StringMap, mutable_mapping_bases.get());
    if (!state->type_StringMap)
    {
        return nullptr;
    }

    Py_INCREF(state->type_StringMap);

    state->type_ValueSet = py::register_python_type(module.get(), type_name_ValueSet, &type_spec_ValueSet, mutable_mapping_bases.get());
    if (!state->type_ValueSet)
    {
        return nullptr;
    }

    Py_INCREF(state->type_ValueSet);

    state->type_IIterable = py::register_python_type(module.get(), type_name_IIterable, &type_spec_IIterable, bases.get());
    if (!state->type_IIterable)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IIterable);

    state->type_IIterator = py::register_python_type(module.get(), type_name_IIterator, &type_spec_IIterator, bases.get());
    if (!state->type_IIterator)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IIterator);

    state->type_IKeyValuePair = py::register_python_type(module.get(), type_name_IKeyValuePair, &type_spec_IKeyValuePair, bases.get());
    if (!state->type_IKeyValuePair)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IKeyValuePair);

    state->type_IMapChangedEventArgs = py::register_python_type(module.get(), type_name_IMapChangedEventArgs, &type_spec_IMapChangedEventArgs, bases.get());
    if (!state->type_IMapChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IMapChangedEventArgs);

    state->type_IMapView = py::register_python_type(module.get(), type_name_IMapView, &type_spec_IMapView, mapping_bases.get());
    if (!state->type_IMapView)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IMapView);

    state->type_IMap = py::register_python_type(module.get(), type_name_IMap, &type_spec_IMap, mutable_mapping_bases.get());
    if (!state->type_IMap)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IMap);

    state->type_IObservableMap = py::register_python_type(module.get(), type_name_IObservableMap, &type_spec_IObservableMap, mutable_mapping_bases.get());
    if (!state->type_IObservableMap)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IObservableMap);

    state->type_IObservableVector = py::register_python_type(module.get(), type_name_IObservableVector, &type_spec_IObservableVector, mutable_sequence_bases.get());
    if (!state->type_IObservableVector)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IObservableVector);

    state->type_IPropertySet = py::register_python_type(module.get(), type_name_IPropertySet, &type_spec_IPropertySet, mutable_mapping_bases.get());
    if (!state->type_IPropertySet)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IPropertySet);

    state->type_IVectorChangedEventArgs = py::register_python_type(module.get(), type_name_IVectorChangedEventArgs, &type_spec_IVectorChangedEventArgs, bases.get());
    if (!state->type_IVectorChangedEventArgs)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IVectorChangedEventArgs);

    state->type_IVectorView = py::register_python_type(module.get(), type_name_IVectorView, &type_spec_IVectorView, sequence_bases.get());
    if (!state->type_IVectorView)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IVectorView);

    state->type_IVector = py::register_python_type(module.get(), type_name_IVector, &type_spec_IVector, mutable_sequence_bases.get());
    if (!state->type_IVector)
    {
        return nullptr;
    }

    Py_INCREF(state->type_IVector);
